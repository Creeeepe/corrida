class Game {
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      //Criar a finishLine e um if para mudar gameState e também o rank para quando player.posititionY for maior que finishline
...
showLeaderboard(){
  ...
  if((players[0].rank === 0 && players[1].rank === 0) || players[0].rank ===1){
    //&emsp; é uma tag usada para exibir quatro espaços 
